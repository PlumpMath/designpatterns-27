...
namespace DrawingApp
{
    public partial class DrawingApp : Form
    {
        ...
        static Queue<Shape> shapequeue;
        Shape outline;
        Random Random = new Random();
        static List<Shape> shapeList;
        static List<Shape> redoList;
        ...
        class DrawingWindow
        {
            ...
            public void Redo()
            {
                ...
                if (_current < commandList.Count - 1)
                {
                    UndoableCommand command = commandList[_current++];
                    command.Execute();
                }
            }
            public void Undo()
